    ...
    <div className="admin-layout-grid" style={{ display: 'grid', gridTemplateColumns: '244px 1fr', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <main style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <div className="admin-page-content" style={{ padding: '26px 32px 80px' }}>
          ...
          {zones.length === 0 ? (
            <div className="admin-row-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <div className="admin-row-grid" style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 16, alignItems: 'start' }}>
              {/* Zone list */}
              <div style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 10, overflow: 'hidden' }}>
